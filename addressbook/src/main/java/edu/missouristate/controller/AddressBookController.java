...
public class AddressBookController {
    ...
    public String postAddEditAddress(HttpSession session, Address address) {
        try {
            ...
            // This is really cool! If we are missing the addressId on the address // then we are "adding" a new record. Hibernate knows and creates
            // the Insert statement when we call save(address). If the addressId is // not null then Hibernate knows and creates the Update statement when // we call save(address). Again, we do not need to write any SQL.
